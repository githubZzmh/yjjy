    ...
    MLoading.prototype={
        ...
        initElement:function () {
            ...
            var curtainElement=dom.children(".mloading"),
                ...
                boxElement = barElement.find(".progressBar"),
                percentElement = barElement.find(".percent");
            ...
            if (boxElement.length == 0) {
                boxElement = $('<div class="progressBar"></div>');
                barElement.append(boxElement);
            }
            if (percentElement.length == 0) {
                percentElement = $('<div class="percent"></div>');
                barElement.append(percentElement);
            }
