package cn.com.ctrl.yjjy.common.utils.http;
...
public class HttpUtils {
     ...
     *
     * @param url   发送请求的 URL
     * @param params 请求参数，请求参数应该是 JSONObject 的形式。
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String url, JSONObject params) {
        ...
        try {
            ...
            if(statusCode == HttpStatus.SC_OK){
                ...
                //解析json格式的返回结果
                Object idsJSON = JSONArray.toJSON(EntityUtils.toString(resEntity));
                result.append(idsJSON);
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost2(String url, JSONObject params) {
        OutputStreamWriter out = null;
        BufferedReader in = null;
        StringBuilder result = new StringBuilder();
        try {
