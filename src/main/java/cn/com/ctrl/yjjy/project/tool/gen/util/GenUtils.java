package cn.com.ctrl.yjjy.project.tool.gen.util;

import cn.com.ctrl.yjjy.common.constant.CommonMap;
...
import cn.com.ctrl.yjjy.framework.config.GenConfig;
import cn.com.ctrl.yjjy.project.tool.gen.domain.ColumnInfo;
...
public class GenUtils {
     ...
     * 项目空间路径
     */
    private static final String PROJECT_PATH = "main/java/cn/com/ctrl/yjjy/project" ;
    ...
    public static String getFileName(String template, TableInfo table, String moduleName) {
        ...
        String mybatisPath = MYBATIS_PATH + "/" + moduleName + "/" + classname + "/" + className;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getModuleName("cn.com.ctrl.yjjy.project.system"));
    }
}
