package cn.com.ctrl.yjjy.project.tool.map.mapper;
 ...
 * @date 2018-12-31
 */
public interface DijsktraMapper {
    /**
     * 查询标点矩阵信息
     *
     * @param id 标点矩阵ID
    ...
    List<Dijsktra> selectDijsktraByLarr(Dijsktra dijsktra);
    /**
     * 查询预案结束标点
     *
     * @param id 标点矩阵信息
     ...
     * @return 结果
     */
    int deleteDijsktraById(String id);
     ...
     * @return 标点列表
     */
    List<DAisle> selectMYJZ(String arr);

    String selectMaxWeightNum();

    List<Dijsktra> selectList(Map map);


    Dijsktra selectByPointId(Dijsktra dijsktra);
}