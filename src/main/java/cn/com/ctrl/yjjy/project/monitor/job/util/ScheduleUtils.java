package cn.com.ctrl.yjjy.project.monitor.job.util;

import cn.com.ctrl.yjjy.common.constant.ScheduleConstants;
import cn.com.ctrl.yjjy.common.exception.job.TaskException;
import org.quartz.*;
...
public class ScheduleUtils {
     ...
     * 创建定时任务
     */
    public static void createScheduleJob(Scheduler scheduler, cn.com.ctrl.yjjy.project.monitor.job.domain.Job job) {
        try {
            // 构建job信息
     ...
     * 更新定时任务
     */
    public static void updateScheduleJob(Scheduler scheduler, cn.com.ctrl.yjjy.project.monitor.job.domain.Job job) {
        try {
     ...
     * 立即执行任务
     */
    public static int run(Scheduler scheduler, cn.com.ctrl.yjjy.project.monitor.job.domain.Job job) {
        int rows = 0;
        try {
            // 参数
    ...
    public static CronScheduleBuilder handleCronScheduleMisfirePolicy(cn.com.ctrl.yjjy.project.monitor.job.domain.Job job, CronScheduleBuilder cb)
