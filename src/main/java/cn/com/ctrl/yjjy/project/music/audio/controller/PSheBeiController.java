...
@Log4j2
@Controller
@RequestMapping("/music/host")
public class PSheBeiController extends BaseController {
    ...
    @RequiresPermissions("music:host:view")
    @GetMapping()
     ...
     * 查询设备列表
     */
    @RequiresPermissions("music:host:list")
    @PostMapping("/list")
    @ResponseBody
    ...
    @RequiresPermissions("music:host:starttime")
    ...
    @RequiresPermissions("music:host:stoptime")
