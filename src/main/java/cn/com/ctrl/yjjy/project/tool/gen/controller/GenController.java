package cn.com.ctrl.yjjy.project.tool.gen.controller;

import cn.com.ctrl.yjjy.common.support.Convert;
import cn.com.ctrl.yjjy.framework.aspectj.lang.annotation.Log;
import cn.com.ctrl.yjjy.project.tool.gen.service.IGenService;
...
public class GenController extends BaseController {
    ...
    public void genCode(HttpServletResponse response, @PathVariable("tableName") String tableName) throws IOException {
        ...
        response.reset();
        response.setHeader("Content-Disposition" , "attachment; filename=\"yjjy.zip\"");
